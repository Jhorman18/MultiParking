...
const Footer = () => {
    return (
        <div>
            <footer className="bg-night text-gray-400 text-sm">
                <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-20 lg:gap-32 xl:gap-42">
                    {/* Brand and description */}
                    <div className="mb-8 md:mb-0 text-center md:text-left my-8">
                ...
                {/* Copyright */}
                <div className="text-center text-gray-400 pb-4 mt-16">
